function data_proc = PREPROCESS_CCEPS(out,data,demean)
...
if ~all(isnan(data))
    ...
    prestim_data = FILTER_CCEPS(prestim_data,out.other.stim.fs); 
    poststim_data = FILTER_CCEPS(poststim_data,out.other.stim.fs);%,[],[],data_mean);
